//---------------------------------------------------------------------
// usbdata.c
// Various tables, Joystick mapping presets, Keyboard scancodes,
// HID->PS2 mappings, etc
//---------------------------------------------------------------------
#include <stdio.h>
#include <string.h>
#include "system.h"
...
__xdata const uint8_t StandardKeyboardDescriptor[] = {
...
__xdata const uint8_t StandardMouseDescriptor[] = {
    0x05, 0x01, // Usage Page (Generic Desktop Ctrls)
