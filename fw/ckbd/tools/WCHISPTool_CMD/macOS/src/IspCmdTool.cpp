...
int main(int argc, char * argv[]) {
    ...
    sprintf(TextBufferTmp, "p:%s\r\nb:%d\r\nv:%d\r\nc:%s\r\no:%d\r\nf:%s\r\nr:%d\r\n",
        cmdPara.PortName, cmdPara.PortBaud, cmdPara.bPrtVer, cmdPara.CfgFile, cmdPara.OptType, cmdPara.FlashFile, cmdPara.bRemoveProtect);
    std::cout << TextBufferTmp << std::endl;
...
retry:
    ...
    if (cmdPara.OptType == 0 && cmdPara.bRemoveProtect && bRemove == FALSE) {
