/*	$NetBSD: emu->c,v 1.10 2014/08/04 21:41:44 joerg Exp $	*/
...
get_data_segment(struct X86EMU *emu)
{
    ...
    x86dbg("unexpected SYSMODE_SEGMASK %08x. Halting.\n", emu->x86.mode & SYSMODE_SEGMASK);
    X86EMU_halt_sys(emu);
    return 0L;
}
/****************************************************************************
...
X86EMU_exec_one_byte(struct X86EMU * emu)
{
    ...
    case 0xf3:
        ...
        break;
    case 0xf4:
        //x86dbg("unexpected op1 at %04x %04x\n", emu->x86.R_CS, emu->x86.R_IP);
        X86EMU_halt_sys(emu);
        break;
    case 0xf5:
        x86emuOp_cmc(emu);
