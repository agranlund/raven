...
#define TEST_OP_F_FF "fadd"
#define TEST_FUNC_F_FF fpu_add
#include "testdriver.h"


static test_f_ff_data const fadd_data[] = {
	...
	{ __LINE__, ZERO_M, ZERO_M, ZERO_M, FLAG_FAIL_ARANYM },
	...
	{ __LINE__, INF_M, INF_M, INF_M, FLAG_XFAIL_LINUX },
...
#ifdef TEST_OP_F_FF
	status |= test_table_f_ff_op(fadd_data, ARRAY_SIZE(fadd_data), __FILE__);
#endif
#ifdef TEST_FUNC_F_FF
	status |= test_table_f_ff_func(fadd_data, ARRAY_SIZE(fadd_data), __FILE__);
#endif
