...
#define TEST_OP_F_F "fint"
#define TEST_FUNC_F_F fpu_int
#include "testdriver.h"

test_f_f_data const fint_data[] = {
	...
	{ __LINE__, HEXCONSTE("4.5", 0x4001, 0x90000000L, 0x00000000L), HEXCONSTE("4.0", 0x4001, 0x80000000L, 0x00000000L), FLAG_FAIL_X87 },
	{ __LINE__, HEXCONSTE("3.5", 0x4000, 0xe0000000L, 0x00000000L), HEXCONSTE("4.0", 0x4001, 0x80000000L, 0x00000000L), 0 },
	{ __LINE__, HEXCONSTE("2.5", 0x4000, 0xa0000000L, 0x00000000L), HEXCONSTE("2.0", 0x4000, 0x80000000L, 0x00000000L), FLAG_FAIL_X87 },
	...
	{ __LINE__, HEXCONSTE("0.5", 0x3ffe, 0x80000000L, 0x00000000L), HEXCONSTE("0.0", 0x0000, 0x00000000L, 0x00000000L), FLAG_FAIL_X87 },
	{ __LINE__, HEXCONSTE("-0.5", 0xbffe, 0x80000000L, 0x00000000L), HEXCONSTE("-0.0", 0x8000, 0x00000000L, 0x00000000L), FLAG_FAIL_X87 },
	...
	{ __LINE__, HEXCONSTE("-2.5", 0xc000, 0xa0000000L, 0x00000000L), HEXCONSTE("-2.0", 0xc000, 0x80000000L, 0x00000000L), FLAG_FAIL_X87 },
	{ __LINE__, HEXCONSTE("-3.5", 0xc000, 0xe0000000L, 0x00000000L), HEXCONSTE("-4.0", 0xc001, 0x80000000L, 0x00000000L), 0 },
	{ __LINE__, HEXCONSTE("-4.5", 0xc001, 0x90000000L, 0x00000000L), HEXCONSTE("-4.0", 0xc001, 0x80000000L, 0x00000000L), FLAG_FAIL_X87 },
	...
	{ __LINE__, HEXCONSTE("-0.25", 0xbffd, 0x80000000L, 0x00000000L), ZERO_M, 0 },
	{ __LINE__, HEXCONSTE("-0.625", 0xbffe, 0xa0000000L, 0x00000000L), HEXCONSTE("-1.0", 0xbfff, 0x80000000L, 0x00000000L), 0 },
	{ __LINE__, HEXCONSTE("2097152.5", 0x4014, 0x80000200L, 0x00000000L), HEXCONSTE("2097152", 0x4014, 0x80000000L, 0x00000000L), FLAG_FAIL_X87 },
	{ __LINE__, HEXCONSTE("-2097152.5", 0xc014, 0x80000200L, 0x00000000L), HEXCONSTE("-2097152", 0xc014, 0x80000000L, 0x00000000L), FLAG_FAIL_X87 },
	...
	{ __LINE__, HEXCONSTE("4503599627370496.5", 0x4033, 0x80000000L, 0x00000400L), HEXCONSTE("4503599627370496.0", 0x4033, 0x80000000L, 0x00000000L), FLAG_FAIL_X87 },
	...
	{ __LINE__, HEXCONSTE("-4503599627370496.5", 0xc033, 0x80000000L, 0x00000400L), HEXCONSTE("-4503599627370496.0", 0xc033, 0x80000000L, 0x00000000L), FLAG_FAIL_X87 },
	...
	{ __LINE__, HEXCONSTE("9007199254740992.5", 0x4034, 0x80000000L, 0x00000200L), HEXCONSTE("9007199254740992.0", 0x4034, 0x80000000L, 0x00000000L), FLAG_FAIL_X87 },
	...
	{ __LINE__, HEXCONSTE("-9007199254740992.5", 0xc034, 0x80000000L, 0x00000200L), HEXCONSTE("-9007199254740992.0", 0xc034, 0x80000000L, 0x00000000L), FLAG_FAIL_X87 },
	...
	{ __LINE__, HEXCONSTE("72057594037927936.5", 0x4037, 0x80000000L, 0x00000040L), HEXCONSTE("72057594037927936.0", 0x4037, 0x80000000L, 0x00000000L), FLAG_FAIL_X87 },
	...
	{ __LINE__, HEXCONSTE("-72057594037927936.5", 0xc037, 0x80000000L, 0x00000040L), HEXCONSTE("-72057594037927936.0", 0xc037, 0x80000000L, 0x00000000L), FLAG_FAIL_X87 },
...
#ifdef TEST_OP_F_F
	status |= test_table_f_f_op(fint_data, ARRAY_SIZE(fint_data), __FILE__);
#endif
#ifdef TEST_FUNC_F_F
	status |= test_table_f_f_func(fint_data, ARRAY_SIZE(fint_data), __FILE__);
#endif
