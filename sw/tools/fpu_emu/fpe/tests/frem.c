...
#define TEST_OP_F_FF "frem"
#define TEST_FUNC_F_FF fpu_rem
...
static test_f_ff_data const frem_data[] = {
	/* frem (x, +0) == qNaN plus invalid exception.  */
	...
	/* frem (+inf, y) == qNaN plus invalid exception.  */
	...
	/* frem (x, +inf) == x for x not infinite.  */
	...
	{ __LINE__, HEXCONSTE("-2", 0xc000, 0x80000000L, 0x00000000L), HEXCONSTE("1", 0x3fff, 0x80000000L, 0x00000000L), ZERO_M, FLAG_XFAIL_LINUX|FLAG_FAIL_STONX|FLAG_FAIL_ARANYM }, /* should be ZERO_P */
	{ __LINE__, HEXCONSTE("-2", 0xc000, 0x80000000L, 0x00000000L), HEXCONSTE("-1", 0xbfff, 0x80000000L, 0x00000000L), ZERO_M, FLAG_XFAIL_LINUX|FLAG_FAIL_STONX|FLAG_FAIL_ARANYM }, /* should be ZERO_P */
	...
	{ __LINE__, HEXCONSTE("5.0", 0x4001, 0xa0000000L, 0x00000000L), HEXCONSTE("2.0", 0x4000, 0x80000000L, 0x00000000L), HEXCONSTE("1.0", 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_STONX|FLAG_FAIL_ARANYM }, /* should be -1.0 */
...
#ifdef TEST_OP_F_FF
	status |= test_table_f_ff_op(frem_data, ARRAY_SIZE(frem_data), __FILE__);
#endif
#ifdef TEST_FUNC_F_FF
	status |= test_table_f_ff_func(frem_data, ARRAY_SIZE(frem_data), __FILE__);
#endif
