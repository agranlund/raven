...
#define TEST_OP_F_F "fetox"
#define TEST_FUNC_F_F fpu_etox
...
static test_f_f_data const fetox_data[] = {
	...
	{ __LINE__, HEXCONSTE("-9.53674316406250000000e-07", 0xbfeb, 0x80000000L, 0x00000000L), HEXCONSTE("9.99999046326138340938e-01", 0x3ffe, 0xfffff000L, 0x007ffffdL), 0 },
	...
	{ __LINE__, HEXCONSTE("-8.67361737988403547206e-19", 0xbfc3, 0x80000000L, 0x00000000L), HEXCONSTE("9.99999999999999999133e-01", 0x3ffe, 0xffffffffL, 0xfffffff0L), 0 },
...
#ifdef TEST_OP_F_F
	status |= test_table_f_f_op(fetox_data, ARRAY_SIZE(fetox_data), __FILE__);
#endif
#ifdef TEST_FUNC_F_F
	status |= test_table_f_f_func(fetox_data, ARRAY_SIZE(fetox_data), __FILE__);
#endif
