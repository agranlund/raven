...
#define TEST_OP_F_F "fintrz"
#define TEST_FUNC_F_F fpu_intrz
...
#ifdef TEST_OP_F_F
	status |= test_table_f_f_op(fintrz_data, ARRAY_SIZE(fintrz_data), __FILE__);
#endif
#ifdef TEST_FUNC_F_F
	status |= test_table_f_f_func(fintrz_data, ARRAY_SIZE(fintrz_data), __FILE__);
#endif
