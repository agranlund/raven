...
#define TEST_OP_F_F "fatan"
#define TEST_FUNC_F_F fpu_atan
...
static test_f_f_data const fatan_data[] = {
	...
	{ __LINE__, INF_P, HEXCONST_PI_2, FLAG_XFAIL_LINUX },
	{ __LINE__, INF_M, HEXCONST_PI_2_M, FLAG_XFAIL_LINUX },
	...
	{ __LINE__, HEXCONSTE("1.00000000000000000000e+06", 0x4012, 0xf4240000L, 0x00000000L), HEXCONSTE("1.57079532679489661956e+00", 0x3fff, 0xc90fd23eL, 0xa5986741L), 0 },
...
#ifdef TEST_OP_F_F
	status |= test_table_f_f_op(fatan_data, ARRAY_SIZE(fatan_data), __FILE__);
#endif
#ifdef TEST_FUNC_F_F
	status |= test_table_f_f_func(fatan_data, ARRAY_SIZE(fatan_data), __FILE__);
#endif
