...
#define TEST_OP_F_F "fatanh"
#define TEST_FUNC_F_F fpu_atanh
...
#ifdef TEST_OP_F_F
	status |= test_table_f_f_op(fatanh_data, ARRAY_SIZE(fatanh_data), __FILE__);
#endif
#ifdef TEST_FUNC_F_F
	status |= test_table_f_f_func(fatanh_data, ARRAY_SIZE(fatanh_data), __FILE__);
#endif
