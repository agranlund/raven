...
#define TEST_OP_F_F "flog2"
#define TEST_FUNC_F_F fpu_log2
...
#ifdef TEST_OP_F_F
	status |= test_table_f_f_op(flog2_data, ARRAY_SIZE(flog2_data), __FILE__);
#endif
#ifdef TEST_FUNC_F_F
	status |= test_table_f_f_func(flog2_data, ARRAY_SIZE(flog2_data), __FILE__);
#endif
