...
#define TEST_OP_F_F "fsinh"
#define TEST_FUNC_F_F fpu_sinh
...
static test_f_f_data const fsinh_data[] = {
	...
	{ __LINE__, HEXCONSTE("-1.18973149535723176502e+4932", 0xfffe, 0xffffffffL, 0xffffffffL), INF_M, 0 },
...
#ifdef TEST_OP_F_F
	status |= test_table_f_f_op(fsinh_data, ARRAY_SIZE(fsinh_data), __FILE__);
#endif
#ifdef TEST_FUNC_F_F
	status |= test_table_f_f_func(fsinh_data, ARRAY_SIZE(fsinh_data), __FILE__);
#endif
