...
#define TEST_OP_F_FF "fdiv"
#define TEST_FUNC_F_FF fpu_div
#include "testdriver.h"



static test_f_ff_data const fdiv_data[] = {
	...
	{ __LINE__, HEXCONSTE("1.0", 0x3fff, 0x80000000L, 0x00000000L), INF_P, ZERO_P, FLAG_XFAIL_LINUX },
	{ __LINE__, HEXCONSTE("1.0", 0x3fff, 0x80000000L, 0x00000000L), INF_M, ZERO_M, FLAG_XFAIL_LINUX|FLAG_FAIL_ARANYM },
	{ __LINE__, HEXCONSTE("-1.0", 0xbfff, 0x80000000L, 0x00000000L), INF_P, ZERO_M, FLAG_XFAIL_LINUX|FLAG_FAIL_ARANYM },
	{ __LINE__, HEXCONSTE("-1.0", 0xbfff, 0x80000000L, 0x00000000L), INF_M, ZERO_P, FLAG_XFAIL_LINUX },
	{ __LINE__, ZERO_P, HEXCONSTE("2.0", 0x4000, 0x80000000L, 0x00000000L), ZERO_P, 0 },
	{ __LINE__, ZERO_P, HEXCONSTE("-2.0", 0xc000, 0x80000000L, 0x00000000L), ZERO_M, FLAG_FAIL_ARANYM }, /* note: documentation incorrectly says +0.0 */
	{ __LINE__, ZERO_M, HEXCONSTE("2.0", 0x4000, 0x80000000L, 0x00000000L), ZERO_M, FLAG_FAIL_ARANYM },
	...
	{ __LINE__, ZERO_P, INF_M, ZERO_M, FLAG_XFAIL_LINUX|FLAG_FAIL_ARANYM },
	{ __LINE__, ZERO_M, INF_P, ZERO_M, FLAG_XFAIL_LINUX|FLAG_FAIL_ARANYM },
	{ __LINE__, ZERO_M, INF_M, ZERO_P, FLAG_XFAIL_LINUX },
	{ __LINE__, INF_P, HEXCONSTE("1.0", 0x3fff, 0x80000000L, 0x00000000L), INF_P, FLAG_XFAIL_LINUX },
	{ __LINE__, INF_P, HEXCONSTE("-1.0", 0xbfff, 0x80000000L, 0x00000000L), INF_M, FLAG_XFAIL_LINUX },
	{ __LINE__, INF_M, HEXCONSTE("1.0", 0x3fff, 0x80000000L, 0x00000000L), INF_M, FLAG_XFAIL_LINUX },
	{ __LINE__, INF_M, HEXCONSTE("-1.0", 0xbfff, 0x80000000L, 0x00000000L), INF_P, FLAG_XFAIL_LINUX },
	{ __LINE__, INF_P, ZERO_P, INF_P, FLAG_XFAIL_LINUX },
	{ __LINE__, INF_P, ZERO_M, INF_M, FLAG_XFAIL_LINUX },
	{ __LINE__, INF_M, ZERO_P, INF_M, FLAG_XFAIL_LINUX },
	{ __LINE__, INF_M, ZERO_M, INF_P, FLAG_XFAIL_LINUX },
	...
	{ __LINE__, HEXCONSTE("10.0", 0x4002, 0xa0000000L, 0x00000000L), HEXCONSTE("3.0", 0x4000, 0xc0000000L, 0x00000000L), HEXCONSTE("3.33333333333333333333333333333333333333", 0x4000, 0xd5555555L, 0x55555555L), 0 },
};
...
#ifdef TEST_OP_F_FF
	status |= test_table_f_ff_op(fdiv_data, ARRAY_SIZE(fdiv_data), __FILE__);
#endif
#ifdef TEST_FUNC_F_FF
	status |= test_table_f_ff_func(fdiv_data, ARRAY_SIZE(fdiv_data), __FILE__);
#endif
