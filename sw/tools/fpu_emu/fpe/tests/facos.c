...
#define TEST_OP_F_F "facos"
#define TEST_FUNC_F_F fpu_acos
...
static test_f_f_data const facos_data[] = {
	...
	{ __LINE__, HEXCONSTE("-9.99999940395355224609e-01", 0xbffe, 0xffffff00L, 0x00000000L), HEXCONSTE("3.14124738660507703486e+00", 0x4000, 0xc90a327aL, 0x8750454aL), 0 },
	{ __LINE__, HEXCONSTE("1.00000000000000000000e+00", 0x3fff, 0x80000000L, 0x00000000L), HEXCONSTE("0.00000000000000000000e+00", 0x0000, 0x00000000L, 0x00000000L), 0 },
	{ __LINE__, HEXCONSTE("9.99999940395355224609e-01", 0x3ffe, 0xffffff00L, 0x00000000L), HEXCONSTE("3.45266984716203587610e-04", 0x3ff3, 0xb504f343L, 0x0f9d56c9L), FLAG_INEXACT2 },
	...
	{ __LINE__, HEXCONSTE("-9.99999940395355224609e-01", 0xbffe, 0xffffff00L, 0x00000000L), HEXCONSTE("3.14124738660507703486e+00", 0x4000, 0xc90a327aL, 0x8750454aL), 0 },
	{ __LINE__, HEXCONSTE("-1.00000000000000000000e+00", 0xbfff, 0x80000000L, 0x00000000L), HEXCONSTE("3.14159265358979323851e+00", 0x4000, 0xc90fdaa2L, 0x2168c235L), 0 },
	{ __LINE__, HEXCONSTE("-9.99999999883584678173e-01", 0xbffe, 0xffffffffL, 0x80000000L), HEXCONSTE("3.14157739480073059041e+00", 0x4000, 0xc90f9aa2L, 0x2168bf8aL), 0 },
	{ __LINE__, HEXCONSTE("1.00000000000000000000e+00", 0x3fff, 0x80000000L, 0x00000000L), HEXCONSTE("0.00000000000000000000e+00", 0x0000, 0x00000000L, 0x00000000L), 0 },
	{ __LINE__, HEXCONSTE("9.99999940395355224609e-01", 0x3ffe, 0xffffff00L, 0x00000000L), HEXCONSTE("3.45266984716203587610e-04", 0x3ff3, 0xb504f343L, 0x0f9d56c9L), FLAG_INEXACT2 },
	...
	{ __LINE__, HEXCONSTE("9.99999940395355224609e-01", 0x3ffe, 0xffffff00L, 0x00000000L), HEXCONSTE("3.45266984716203587610e-04", 0x3ff3, 0xb504f343L, 0x0f9d56c9L), FLAG_INEXACT2 },
	{ __LINE__, HEXCONSTE("9.99999999999999888978e-01", 0x3ffe, 0xffffffffL, 0xfffff800L), HEXCONSTE("1.49011611938476563873e-08", 0x3fe5, 0x80000000L, 0x00000070L), FLAG_INEXACT2 },
	{ __LINE__, HEXCONSTE("9.99999999999999999946e-01", 0x3ffe, 0xffffffffL, 0xffffffffL), HEXCONSTE("3.29272253991359623327e-10", 0x3fdf, 0xb504f333L, 0xf9de6484L), 0 },
	{ __LINE__, HEXCONSTE("-9.99999940395355224609e-01", 0xbffe, 0xffffff00L, 0x00000000L), HEXCONSTE("3.14124738660507703486e+00", 0x4000, 0xc90a327aL, 0x8750454aL), 0 },
	{ __LINE__, HEXCONSTE("-1.00000000000000000000e+00", 0xbfff, 0x80000000L, 0x00000000L), HEXCONSTE("3.14159265358979323851e+00", 0x4000, 0xc90fdaa2L, 0x2168c235L), 0 },
	{ __LINE__, HEXCONSTE("-9.99999999999999888978e-01", 0xbffe, 0xffffffffL, 0xfffff800L), HEXCONSTE("3.14159263868863204467e+00", 0x4000, 0xc90fda92L, 0x2168c235L), 0 },
	{ __LINE__, HEXCONSTE("-9.99999999999999999946e-01", 0xbffe, 0xffffffffL, 0xffffffffL), HEXCONSTE("3.14159265326052098452e+00", 0x4000, 0xc90fdaa1L, 0xc6e6489bL), 0 },
	{ __LINE__, HEXCONSTE("1.00000000000000000000e+00", 0x3fff, 0x80000000L, 0x00000000L), HEXCONSTE("0.00000000000000000000e+00", 0x0000, 0x00000000L, 0x00000000L), 0 },
	{ __LINE__, HEXCONSTE("9.99999940395355224609e-01", 0x3ffe, 0xffffff00L, 0x00000000L), HEXCONSTE("3.45266984716203587610e-04", 0x3ff3, 0xb504f343L, 0x0f9d56c9L), FLAG_INEXACT2 },
	{ __LINE__, HEXCONSTE("9.99999999999999888978e-01", 0x3ffe, 0xffffffffL, 0xfffff800L), HEXCONSTE("1.49011611938476563873e-08", 0x3fe5, 0x80000000L, 0x00000070L), FLAG_INEXACT2 },
	{ __LINE__, HEXCONSTE("9.99999999999999999946e-01", 0x3ffe, 0xffffffffL, 0xffffffffL), HEXCONSTE("3.29272253991359623327e-10", 0x3fdf, 0xb504f333L, 0xf9de6484L), 0 },
	...
	{ __LINE__, SUBNORM_P, HEXCONSTE("1.57079632679489661926e+00", 0x3fff, 0xc90fdaa2L, 0x2168c235L), FLAG_INEXACT2 },
	...
	{ __LINE__, SUBNORM_M, HEXCONSTE("1.57079632679489661926e+00", 0x3fff, 0xc90fdaa2L, 0x2168c235L), FLAG_INEXACT2 },
};
...
#ifdef TEST_OP_F_F
	status |= test_table_f_f_op(facos_data, ARRAY_SIZE(facos_data), __FILE__);
#endif
#ifdef TEST_FUNC_F_F
	status |= test_table_f_f_func(facos_data, ARRAY_SIZE(facos_data), __FILE__);
#endif
