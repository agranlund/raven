...
#define TEST_OP_F_F "fasin"
#define TEST_FUNC_F_F fpu_asin
...
static test_f_f_data const fasin_data[] = {
	...
	{ __LINE__, ZERO_M, ZERO_M, 0 }, /* sometimes fails on ARAnyM, returning +0 ??? */
	...
	{ __LINE__, HEXCONSTE("1.00000000000000000000e+00", 0x3fff, 0x80000000L, 0x00000000L), HEXCONSTE("1.57079632679489661926e+00", 0x3fff, 0xc90fdaa2L, 0x2168c235L), 0 },
	{ __LINE__, HEXCONSTE("9.99999940395355224609e-01", 0x3ffe, 0xffffff00L, 0x00000000L), HEXCONSTE("1.57045105981018041561e+00", 0x3fff, 0xc9048a52L, 0xed37c85fL), FLAG_INEXACT },
	{ __LINE__, HEXCONSTE("9.99999999999996447286e-01", 0x3ffe, 0xffffffffL, 0xffff0000L), HEXCONSTE("1.57079624250119959745e+00", 0x3fff, 0xc90fd9edL, 0x1c758e3bL), 0 },
	{ __LINE__, HEXCONSTE("-9.99999940395355224609e-01", 0xbffe, 0xffffff00L, 0x00000000L), HEXCONSTE("-1.57045105981018041561e+00", 0xbfff, 0xc9048a52L, 0xed37c85fL), FLAG_INEXACT },
	{ __LINE__, HEXCONSTE("-1.00000000000000000000e+00", 0xbfff, 0x80000000L, 0x00000000L), HEXCONSTE("-1.57079632679489661926e+00", 0xbfff, 0xc90fdaa2L, 0x2168c235L), 0 },
	{ __LINE__, HEXCONSTE("-9.99999999999996447286e-01", 0xbffe, 0xffffffffL, 0xffff0000L), HEXCONSTE("-1.57079624250119959745e+00", 0xbfff, 0xc90fd9edL, 0x1c758e3bL), 0 },
	{ __LINE__, HEXCONSTE("1.00000000000000000000e+00", 0x3fff, 0x80000000L, 0x00000000L), HEXCONSTE("1.57079632679489661926e+00", 0x3fff, 0xc90fdaa2L, 0x2168c235L), 0 },
	{ __LINE__, HEXCONSTE("9.99999940395355224609e-01", 0x3ffe, 0xffffff00L, 0x00000000L), HEXCONSTE("1.57045105981018041561e+00", 0x3fff, 0xc9048a52L, 0xed37c85fL), FLAG_INEXACT },
	...
	{ __LINE__, HEXCONSTE("9.99999940395355224609e-01", 0x3ffe, 0xffffff00L, 0x00000000L), HEXCONSTE("1.57045105981018041561e+00", 0x3fff, 0xc9048a52L, 0xed37c85fL), FLAG_INEXACT },
	{ __LINE__, HEXCONSTE("9.99999999999999888978e-01", 0x3ffe, 0xffffffffL, 0xfffff800L), HEXCONSTE("1.57079631189373542541e+00", 0x3fff, 0xc90fda82L, 0x2168c235L), 0 },
	{ __LINE__, HEXCONSTE("9.99999999999999999946e-01", 0x3ffe, 0xffffffffL, 0xffffffffL), HEXCONSTE("1.57079632646562436526e+00", 0x3fff, 0xc90fdaa1L, 0x6c63cf01L), 0 },
	{ __LINE__, HEXCONSTE("-9.99999940395355224609e-01", 0xbffe, 0xffffff00L, 0x00000000L), HEXCONSTE("-1.57045105981018041561e+00", 0xbfff, 0xc9048a52L, 0xed37c85fL), FLAG_INEXACT },
	{ __LINE__, HEXCONSTE("-1.00000000000000000000e+00", 0xbfff, 0x80000000L, 0x00000000L), HEXCONSTE("-1.57079632679489661926e+00", 0xbfff, 0xc90fdaa2L, 0x2168c235L), 0 },
	{ __LINE__, HEXCONSTE("-9.99999999999999888978e-01", 0xbffe, 0xffffffffL, 0xfffff800L), HEXCONSTE("-1.57079631189373542541e+00", 0xbfff, 0xc90fda82L, 0x2168c235L), 0 },
	{ __LINE__, HEXCONSTE("-9.99999999999999999946e-01", 0xbffe, 0xffffffffL, 0xffffffffL), HEXCONSTE("-1.57079632646562436526e+00", 0xbfff, 0xc90fdaa1L, 0x6c63cf01L), 0 },
	{ __LINE__, HEXCONSTE("1.00000000000000000000e+00", 0x3fff, 0x80000000L, 0x00000000L), HEXCONSTE("1.57079632679489661926e+00", 0x3fff, 0xc90fdaa2L, 0x2168c235L), 0 },
	{ __LINE__, HEXCONSTE("9.99999940395355224609e-01", 0x3ffe, 0xffffff00L, 0x00000000L), HEXCONSTE("1.57045105981018041561e+00", 0x3fff, 0xc9048a52L, 0xed37c85fL), FLAG_INEXACT },
	{ __LINE__, HEXCONSTE("9.99999999999999888978e-01", 0x3ffe, 0xffffffffL, 0xfffff800L), HEXCONSTE("1.57079631189373542541e+00", 0x3fff, 0xc90fda82L, 0x2168c235L), 0 },
	{ __LINE__, HEXCONSTE("9.99999999999999999946e-01", 0x3ffe, 0xffffffffL, 0xffffffffL), HEXCONSTE("1.57079632646562436526e+00", 0x3fff, 0xc90fdaa1L, 0x6c63cf01L), 0 },
	...
	{ __LINE__, HEXCONSTE("-0.0", 0x8000, 0x00000000L, 0x00000000L), HEXCONSTE("-0.0", 0x8000, 0x00000000L, 0x00000000L), 0 },
};
...
#ifdef TEST_OP_F_F
	status |= test_table_f_f_op(fasin_data, ARRAY_SIZE(fasin_data), __FILE__);
#endif
#ifdef TEST_FUNC_F_F
	status |= test_table_f_f_func(fasin_data, ARRAY_SIZE(fasin_data), __FILE__);
#endif
