...
#define TEST_OP_F_F "flognp1"
#define TEST_FUNC_F_F fpu_lognp1
...
static test_f_f_data const flognp1_data[] = {
	...
	{ __LINE__, HEXCONSTE("9.53674316406250000000e-07", 0x3feb, 0x80000000L, 0x00000000L), HEXCONSTE("9.53673861659188233891e-07", 0x3fea, 0xfffff800L, 0x00555551L), 0 },
	{ __LINE__, HEXCONSTE("2.98023223876953125000e-08", 0x3fe6, 0x80000000L, 0x00000000L), HEXCONSTE("2.98023219436061114727e-08", 0x3fe5, 0xffffffc0L, 0x00001555L), 0 },
	...
	{ __LINE__, HEXCONSTE("2.77555756156289135106e-17", 0x3fc8, 0x80000000L, 0x00000000L), HEXCONSTE("2.77555756156289131254e-17", 0x3fc7, 0xffffffffL, 0xffffff00L), 0 },
	{ __LINE__, HEXCONSTE("8.67361737988403547206e-19", 0x3fc3, 0x80000000L, 0x00000000L), HEXCONSTE("8.67361737988403546830e-19", 0x3fc2, 0xffffffffL, 0xfffffff8L), 0 },
	...
	{ __LINE__, HEXCONSTE("1.07150860718626732095e+301", 0x43e7, 0x80000000L, 0x00000000L), HEXCONSTE("6.93147180559945309430e+02", 0x4008, 0xad496b68L, 0x02e49cd2L), 0 },
	{ __LINE__, HEXCONSTE("3.40282346638528859812e+38", 0x407e, 0xffffff00L, 0x00000000L), HEXCONSTE("8.87228390520683530551e+01", 0x4005, 0xb17217f5L, 0xd1cf78acL), 0 },
...
#ifdef TEST_OP_F_F
	status |= test_table_f_f_op(flognp1_data, ARRAY_SIZE(flognp1_data), __FILE__);
#endif
#ifdef TEST_FUNC_F_F
	status |= test_table_f_f_func(flognp1_data, ARRAY_SIZE(flognp1_data), __FILE__);
#endif
